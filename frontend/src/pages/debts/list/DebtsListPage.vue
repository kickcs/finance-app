    ...
    <main class="px-5 pt-8 space-y-6">
      ...
      <div class="space-y-3">
        ...
        <div v-if="personFilter" class="flex items-center gap-2 px-1">
          <div class="flex items-center gap-2 px-3 py-1.5 bg-primary/10 text-primary rounded-full text-sm">
        ...
        <div class="flex items-center justify-between px-1">
          ...
          <div v-if="activeDebts.length > 0 && !personFilter" class="flex gap-1 bg-surface-light dark:bg-surface-dark rounded-lg p-1">
            <button
              type="button"
