  ...
  async function makePartialPayment(
    ...
    try {
      ...
      if (debt.source_transaction_id) {
        ...
        await transactionsApi.update(debt.source_transaction_id, { amount: newAmount })
      ...
      await Promise.all([
        ...
        queryClient.invalidateQueries({ queryKey: transactionQueryKeys.infiniteByAccount(selectedAccountId) }),
