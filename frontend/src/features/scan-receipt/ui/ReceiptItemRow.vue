  ...
  >
    ...
    >
      ...
      <div class="flex items-center gap-1.5 pl-4">
        <!-- Quantity stepper -->
        <div class="flex items-center bg-surface-light dark:bg-surface-dark rounded-lg border border-border-light dark:border-border-dark">
          <button
            type="button"
            :aria-label="`Уменьшить количество позиции ${index + 1}`"
            class="w-6 h-6 rounded-l-lg flex items-center justify-center
                   text-text-tertiary-light dark:text-text-tertiary-dark
                   hover:text-primary hover:bg-primary/5 active:scale-90 transition-all"
            @click="decrementQty"
          >
          ...
          <input
            ...
            class="w-7 h-6 text-center bg-transparent border-none outline-none
          ...
          <button
            ...
            class="w-6 h-6 rounded-r-lg flex items-center justify-center
                   text-text-tertiary-light dark:text-text-tertiary-dark
                   hover:text-primary hover:bg-primary/5 active:scale-90 transition-all"
            @click="incrementQty"
          >
        ...
        <input
          ...
          class="w-20 bg-transparent border-b border-border-light dark:border-border-dark
                 focus:border-primary outline-none
                 text-caption font-medium text-right
