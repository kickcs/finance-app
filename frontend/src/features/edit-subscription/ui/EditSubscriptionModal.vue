...
const frequencyLabel = computed(() => {
  ...
  return (
    FREQUENCY_LABELS[props.subscription.frequency] ||
  ...
  <Teleport to="body">
    <Transition name="modal">
      ...
      >
        ...
        <!-- Modal Content -->
        <div
          class="relative w-full sm:max-w-md max-h-[90vh] overflow-y-auto bg-card-light dark:bg-card-dark rounded-t-3xl sm:rounded-2xl shadow-2xl"
        >
          <!-- Header -->
          <div
            class="sticky top-0 z-10 px-4 pt-4 pb-3 bg-card-light dark:bg-card-dark border-b border-border-light dark:border-border-dark"
          >
            <div class="flex items-center justify-between">
              ...
              <button
                class="w-7 h-7 flex items-center justify-center rounded-full hover:bg-surface-light dark:hover:bg-surface-dark transition-colors"
                @click="$emit('close')"
              >
                <UIcon
                  name="close"
          ...
          <div v-if="!isEditing" class="p-4 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-2">
              <div class="p-3 rounded-xl bg-surface-light dark:bg-surface-dark">
                <p
                  class="text-xs text-text-secondary-light dark:text-text-secondary-dark mb-0.5"
                >
                  Сумма
                </p>
                <p
          ...
          <div v-else class="p-4 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-3">
              <UInput
                ...
                placeholder="Netflix..."
                @update:model-value="
                  $emit('update-field', 'name', $event as string)
                "
              />
              <UInput
                ...
                :suffix="currency"
                @update:model-value="
                  $emit('update-field', 'amount', Number($event) || 0)
                "
              />
            </div>
              ...
              <UTabs
                ...
                @update:model-value="
                  $emit(
                    'update-field',
                    'frequency',
                    $event as SubscriptionFormData['frequency'],
                  )
                "
              />
            </div>
            ...
            <UInput
              ...
              type="date"
              @update:model-value="
                $emit('update-field', 'next_date', $event as string)
              "
            />
          ...
          <Transition name="fade">
            <div
              ...
              class="absolute inset-0 z-20 flex items-center justify-center bg-card-light/95 dark:bg-card-dark/95 backdrop-blur-sm rounded-t-3xl sm:rounded-2xl"
            >
              <div class="p-4 text-center max-w-xs">
                <div
                  class="w-12 h-12 mx-auto mb-3 rounded-full bg-danger/10 flex items-center justify-center"
                >
                ...
                <p
                  class="text-xs text-text-secondary-light dark:text-text-secondary-dark mb-4"
                >
